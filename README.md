...
Files written by earlier versions (`DLRDIC01`, `DLRDIC02`, `DLRDIC03`) are
rejected with `UnsupportedDictionaryVersion`; rebuild them from the raw MeCab
dictionary files with `ZigTokenizer::write_binary_from_raw_paths` (or Zig's
